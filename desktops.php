...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO desktops(fname,lname,email,pno,pname,price,quantity,town)VALUES('$fname','$lname','$email','$pno','$pname','$price','$quantity','$town')";
...
<button class="btn btn-success btn-block"><h2 style="text-align: center;font-family: algerian;font-weight: bold;">DESKTOPS</h2></button>	
...
<div class="row">
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/57753.jpeg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/ds8.jpg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/ds7.jpg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/ds6.jpg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/ds4.jpg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/ds14.jpg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/ds2.jpg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/ds.jpg"class="btn btn-block">
	<div class="caption">
	...
	<form method="POST"action="desktops.php">
		<table class="table">
		<tr>
			<td>First Name</td>
