...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO laptops(fname,lname,email,pno,pname,price,quantity,town)VALUES('$fname','$lname','$email','$pno','$pname','$price','$quantity','$town')";
...
<button class="btn btn-success btn-block"><h2 style="text-align: center;font-family: algerian;font-weight: bold;">LAPTOPS</h2></button>	
...
<div class="row">
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/lp7.jpg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/lp12.jpg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/lp8.jpg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/lp4.jpg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/lp5.jpg"class="btn btn-block">
	<div class="caption">
	...
	<form method="POST"action="laptops.php">
		<table class="table">
		<tr>
			<td>First Name</td>
