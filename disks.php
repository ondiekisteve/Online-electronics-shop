...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO disks(fname,lname,email,pno,pname,price,quantity,town)VALUES('$fname','$lname','$email','$pno','$pname','$price','$quantity','$town')";
...
<button class="btn btn-success btn-block"><h2 style="text-align: center;font-family: algerian;font-weight: bold;">PORTABLE DISKS</h2></button>	
...
<div class="row">
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/acc36.jpg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/acc21.jpg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/acc40.jpg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/acc18.jpg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/acc4.jpg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/acc37.jpg"class="btn btn-block">
	<div class="caption">
	...
	<div class="col-md-3">
	<div class="thumbnail">
	<img src="img/acc12.jpg"class="btn btn-block">
	<div class="caption">
	...
	<form method="POST"action="disks.php">
		<table class="table">
		<tr>
			<td>First Name</td>
